...
output.insert(tk.END,"Welcome to your Daily Running Tracker©! Before you begin, you need to input some facts      about you. This includes your height, your weight, and your age. This is so we can calculate       your Total Energy Expenditure (TEE). This value is used to estimate your daily calorie needs.    The TEE for men = 864 − 9.72 × age + PA × 14.2 × weight + 503 × height).                                 The TEE for women = 387 − 7.31 × age + PA × (10.9 × weight + 660.7 × height)              																																							   Have fun running! - Stefan")
